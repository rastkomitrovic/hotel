...
public interface ReservationRepository extends PagingAndSortingRepository<Reservation, Long> {
    ...
    @Query(value = "select r from Reservation r where r.user.username=:username or r.employee.username=:username",
    countQuery = "select count (r) from Reservation r where r.user.username=:username or r.employee.username=:username")
